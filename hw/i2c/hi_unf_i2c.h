...
CNcomment: 创建一路GpioI2c CNend

\attention \n
If the specified GPIO pins are used, this API fails to be called.\n
CNcomment:如果Gpio已被占用会失败\n CNend

\param[in] u32I2cNum  ID of the obtained I2C bus                            CNcomment:得到I2C总线号。 CNend
\param[in] whichGpioClock  Group ID of the clock pin, ranging from 0 to 12  CNcomment:Clock管脚组号，取值范围为0～12 CNend
\param[in] whichGpioData   Group ID of the data pin, ranging from 0 to 12   CNcomment:Data管脚组号， 取值范围为0～12 CNend
\param[in] clockBit  Clock pin ID, ranging from 0 to 7                      CNcomment:Clock管脚位号，取值范围为0～7 CNend
\param[in] dataBit   Data pin ID, ranging from 0 to 7                       CNcomment:Data管脚位号， 取值范围为0～7 CNend
\retval 0 Success                                                           CNcomment:成功 CNend
...
N/A
 */
MS_S32 HI_UNF_I2C_Read(MS_U32 u32I2cNum, MS_U8 u8DevAddress, MS_U32 u32RegAddr,
                       MS_U32 u32RegAddrCount, MS_U8 *pu8Buf, MS_U32 u32Length);
...
N/A
 */
MS_S32 HI_UNF_I2C_Write(MS_U32 u32I2cNum, MS_U8 u8DevAddress, MS_U32 u32RegAddr,
                        MS_U32 u32RegAddrCount, MS_U8 * pu8Buf, MS_U32 u32Length);
